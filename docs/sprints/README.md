...
The named sprints are stable milestones. Smaller `0.1.x` or `0.2.x` implementation checkpoints are expected when contracts, fixtures, or tests need hardening before the next milestone.
